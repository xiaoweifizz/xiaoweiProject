...
console.log(66)
  ...
  //       var currentNum=$('.amount_box input:nth-child(2)').val();	
		// $('.list_img a img').attr('src',res[0].imgurl);
		// $('.list_text a').html(res[0].title);


		// $('.list_price .price').html('￥'+res[0].price);
		// $('.amount_box input:nth-child(2)').val(res[0].num);
		// $('.sum_price').html('￥'+currentPrice*currentNum);
			$('.order_content').html(res.map(function(item){
				return `
